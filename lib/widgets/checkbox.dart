...
class _CheckboxCustomState extends State<CheckboxCustom>
  ...
  @override
  void didUpdateWidget(CheckboxCustom oldWidget) {
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    final path1 = Path();
    const start1 = Offset(0, 0);
    const end1 = Offset(_kEdgeSize, _kEdgeSize);
    if (t < 0.5) {
      path1.moveTo(origin.dx + start1.dx, origin.dy + start1.dy);
      path1.lineTo(origin.dx + start1.dx, origin.dy + end1.dy);
      path1.lineTo(origin.dx + end1.dx, origin.dy + end1.dy);
    } else {
      path1.moveTo(origin.dx + start1.dx, origin.dy + start1.dy);
      path1.lineTo(origin.dx + start1.dx, origin.dy + end1.dy);
      path1.lineTo(origin.dx + end1.dx, origin.dy + end1.dy);
      path1.lineTo(origin.dx + end1.dx, origin.dy + start1.dy);
      path1.lineTo(origin.dx + start1.dx, origin.dy + start1.dy);
    }
